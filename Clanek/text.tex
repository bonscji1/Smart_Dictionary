...
přístup k učení je jiný,
elektronika stále častejší jako pomůcka/ je to plnohodnotná náhrada?
jsou však stále lidé preferující pero a papír.

\subsection{pen_vs_notebook}
studie často navazují na sebe, výborně je popsána role noteboků zde.
\cite{mightier_pen} testování zda psaní poznámek na notebboku je lepší.
závěr: více poznámek ale psaných doslovně, psaní perem je však lepší protože strategie.
ani upozornění na psací strategii u notebooků nepomohlo.

\subsection{what_about_e-pen}
to byla studie na psaní poznámek, co však na jednotlivé slova?
navíc existují i elektronická pera a tablety, jaký je jejich dopad?
\cite{advantage_of_handwriting} studie ukazuje,
že i pro studování jednotlivých slov je stále nejlepší ruční psaní.
proč?
